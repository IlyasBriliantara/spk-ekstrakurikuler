...
@section('content')
  ...
  <div class="table-responsive col-lg-12">
    <div class="d-lg-flex justify-content-between gap-2">
      <h1 class="h3 mb-0 text-gray-800">Hasil Perhitungan Perbandingan</h1>
      <a href="/dashboard/criteria-comparisons/{{ $criteria_analysis->id }}" class="btn btn-secondary mb-3">
        <span data-feather="arrow-left"></span>
        Kembali Ke Perbandingan Value
      </a>
    </div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between align-items-center my-4">
      <h1 class="h3 mb-0 text-gray-800">Hasil Perhitungan Value Preventif</h1>
    </div>
      ...
      <thead>
        <tr>
          ...
          @foreach ($criteria_analysis->preventiveValues as $preventValue)
            <th scope="col" class="text-center">{{ $preventValue->criteria->name }}</th>
          @endforeach
          <th scope="col" class="text-center bg-secondary text-white">Preventif Value</th>
        </tr>
      </thead>
      <tbody>
        @php($startAt = 0)
    ...
    {{-- Consistency Ratio --}}
    <div class="d-sm-flex align-items-center justify-content-between align-items-center my-4">
      <h1 class="h3 mb-0 text-gray-800">Hasil Perhitungan Rasio</h1>
    </div>
      ...
      <thead>
        <tr>
          ...
          @foreach ($criteria_analysis->preventiveValues as $preventValue)
            <th scope="col" class="text-center">{{ $preventValue->criteria->name }}</th>
          @endforeach
          <th scope="col" class="text-center bg-secondary text-white">Baris Total</th>
        </tr>
      </thead>
      <tbody>
        @php($startAt = 0)
    ...
    <table class="table table-borderless">
      <thead style="border-bottom: 1px solid #E3E6F0;">
        <tr>
          <th scope="col"></th>
          <th scope="col" class="text-center">Baris Total</th>
          <th></th>
          <th scope="col" class="text-center">Preventif Value</th>
    ...
    <div class="row d-lg-flex justify-content-center">
      <div class="col-12 col-lg-6">
        <table class="table table-bordered">
          <tbody>
            <tr>
              <th scope="row">Nomor Kriteria</th>
            ...
            <tr>
              <th scope="row">Konsistensi Index</th>
              <td>
            ...
            <tr>
              <th scope="row">Konsistensi Rasio</th>
              @php($CR = $CI / $RI)
